...
namespace Packager.Providers
{
    internal class AppConfigLookupsProvider : ILookupsProvider
    {
        ...
        public Dictionary<string, string> PlaybackSpeeds { get; }
        public Dictionary<string, string> TrackConfigurations { get; }
        public Dictionary<string, string> SoundFields { get; }
        public Dictionary<string, string> TapeThicknesses { get; }
