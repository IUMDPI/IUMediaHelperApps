...
namespace Packager.Test.Processors
{
    ...
    public class AudioProcessorTests : AbstractProcessorTests
    {
        ...
        protected override void DoCustomSetup()
        {
            ...
            Processor  = new AudioProcessor(BextProcessor, DirectoryProvider, FileProvider, Hasher, MetadataProvider, Observers, ProgramSettings, XmlExporter, AudioCarrierDataFactory, AudioMetadataFactory, (AudioFFMPEGRunner)FFMPEGRunner);
